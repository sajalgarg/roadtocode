  ...
  var RatingControl = function(element) {
    ...
    self.ratingElements.forEach(function(element) {
      ...
      element.container.addEventListener("ontouchend" in document ? "touchend" : "click", function(e) {
        ...
        document.getElementById("current_rating1").innerHTML = cr;
		self.containerElement.querySelector(".something").innerHTML=cr;
		//self.containerElement.getElementsByClassName("something").innerHTML = "This is it";
...
*/
  ...
  //document.querySelector(".demo-container").classList.add("clip-marker");
  var ratingControl = new RatingControl(document.querySelectorAll(".rating-control")[1]);
  //var ratingControl = new RatingControl(document.querySelector(".demo-container1 .rating-control"));
  var ratingControl = new RatingControl(document.querySelectorAll(".rating-control")[2]);
  var ratingControl = new RatingControl(document.querySelectorAll(".rating-control")[3]);
});
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    self.containerElement = element;
	console.log(this)
   //var newBoolean = element.container.getAttribute("status");
	document.getElementById("current_boolean").innerHTML = br;
	self.containerElement.querySelector(".something").innerHTML = br;
	var btnElement = self.containerElement.querySelector(".status-option");
 
	var btnElement1 = self.containerElement.querySelectorAll(".status-option")[1];
 
 
      btnElement.addEventListener("ontouchend" in document ? "touchend" : "click", function(e) {
        
        var newStatus = btnElement.getAttribute("status");
		//Additon to log
		br = btnElement.getAttribute("status");
      ...
      btnElement1.addEventListener("ontouchend" in document ? "touchend" : "click", function(e) {
        
        var newStatus = btnElement1.getAttribute("status");
		//Additon to log
		br = btnElement1.getAttribute("status");
		console.log("Status changed");
		console.log(br);
		document.getElementById("current_boolean").innerHTML = br;
		self.containerElement.querySelector(".something").innerHTML = br;
